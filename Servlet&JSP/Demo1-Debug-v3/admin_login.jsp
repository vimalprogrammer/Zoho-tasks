...
String user_otp=String.valueOf(session.getAttribute("user_otp"));
String real_otp=String.valueOf(session.getAttribute("real_otp"));

session.setAttribute("user_otp",user_otp);
session.setAttribute("real_otp",real_otp);

// out.println(user_otp);
// out.println(real_otp);

if(user_otp.equals(real_otp))
{
...
if(rs.getString(3).equals(pwd))
{
    ...
    out.println("<a href='Bus/view_bus.jsp' style='font-size:20px;color:black;' >VIEW BUS</a><br><br>");
