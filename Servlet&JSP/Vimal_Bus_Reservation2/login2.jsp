...
<div class="view"><br><h4>Home</h4><br></p></div>
...
try
{
 ...
 {
 ResultSet rs = stmt.executeQuery( "SELECT * FROM user_details where first_name='"+userid+"' and password='"+pwd+"'");
 rs.next();
 email=rs.getString("email");
  ...
  // out.println("<center><h3>Welcome  "+email+"!<br></h3></center>");
...
<br>
<br>
<a href="User/view_ticket.jsp"><button type="button" class="btn btn-light" data-mdb-ripple-color="dark" style="color: black; font-size: 20px;">VIEW MY TICKETS</button></a>
<!-- <a href="User/view_ticket.jsp">VIEW MY TICKETS</a>
 --><br>
<br>
<a href="User/book_ticket1.jsp"><button type="button" class="btn btn-light" data-mdb-ripple-color="dark" style="color: black; font-size: 20px;">BOOK TICKET</button></a>
