...
%>
	...
	<hr/>
	<div class="container">
	<form action="avail_ticket.jsp" method="get" autocomplete="off">
  <div>
...
<form autocomplete="off" action="avail_ticket.jsp">
  <div class="autocomplete" style="width:300px;">
    <input id="myInput" type="text" name="dep" placeholder="Enter Departure">
        <input id="myInput1" type="text" name="des" placeholder="Enter Destination">
  </div>
  <input type="submit">
</form>
...
<form autocomplete="off" action="avail_ticket.jsp">
  <div class="autocomplete" style="width:300px;">
    <input id="myInput" type="text" name="dep" placeholder="Enter Departure"></br></br>
    <input id="myInput1" type="text" name="des" placeholder="Enter Destination">
  </div><br><br>
  <input type="submit">
</form>
