...
public class ZaLoginModule2 implements LoginModule {
	
//-----------------------------------------------------------	

	// public static final String TEST_USERNAME = "vars";
...
if(!flag)
{
	...
	// if(TEST_USERNAME.equals(userid) && TEST_PASSWORD.equals(pwd))
	// {
